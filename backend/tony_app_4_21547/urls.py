"""tony_app_4_21547 URL Configuration
...
admin.site.site_header = "tony-app-4"
admin.site.site_title = "tony-app-4 Admin Portal"
admin.site.index_title = "tony-app-4 Admin"

# swagger
api_info = openapi.Info(
    title="tony-app-4 API",
    default_version="v1",
    description="API documentation for tony-app-4 App",
)
